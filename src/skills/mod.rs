...
async fn handle_bundle_add(
    ...
    Box::pin(working.save_dirty())
        .await
        .with_context(|| format!("failed to persist config after creating skill-bundle '{alias}'"))
}
...
async fn handle_bundle_remove(
    ...
    Box::pin(working.save_dirty())
        .await
        .with_context(|| format!("failed to persist config after removing skill-bundle '{alias}'"))?;
...
async fn handle_bundle_rename(
    ...
    Box::pin(working.save_dirty())
        .await
        .with_context(|| format!("failed to persist config after renaming skill-bundle to '{to}'"))?;
